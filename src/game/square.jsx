...
class Square extends React.Component {
    ...
    content() {
        if (this.props.player) {
            if (this.props.value === 5) return <div className="ship"><i className="fas fa-ship"/></div>;
        }
        if (this.props.value === 3) return <div className="ship"><i className="fas fa-ship"/></div>;
